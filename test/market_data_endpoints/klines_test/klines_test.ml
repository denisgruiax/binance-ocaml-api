...
module BitcoinCandlesticks = Klines.Make(struct let url = BaseUrls.api_default let symbol = "BTCUSDT" let size = "5m" end);;
module MultiversXCandlesticks = Klines.Make(struct let url = BaseUrls.api_default let symbol = "EGLDUSDT" let size = "5m" end);;
module PolkadotCandlesticks = Klines.Make(struct let url = BaseUrls.api_default let symbol = "DOTUSDT" let size = "5m" end);;
